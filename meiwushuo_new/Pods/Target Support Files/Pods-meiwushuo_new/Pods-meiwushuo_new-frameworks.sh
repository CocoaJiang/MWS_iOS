...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${PODS_ROOT}/HyphenateLite/iOS_Pods_IMSDK_V3.6.0/HyphenateLite.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/SOZOChromoplast/SOZOChromoplast.framework"
