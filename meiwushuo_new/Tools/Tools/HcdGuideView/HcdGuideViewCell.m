...
#define kScale(x)       (x*SCREEN_WIDTH/750.0f)
...
- (void)initView {
    ...
    button.hidden = YES;
    CGFloat viewBottomH = 0;
    if (kStatusBarHeight != 20) {
        viewBottomH = 34;
    }
    [button setFrame:CGRectMake(0, kHcdGuideViewBounds.size.height-kScale(170)-viewBottomH, kScale(300), kScale(100))];
    ...
    [self.button setCenter:CGPointMake(kHcdGuideViewBounds.size.width / 2, button.center.y)];
}
