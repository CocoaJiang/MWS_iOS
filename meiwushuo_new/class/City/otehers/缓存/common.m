...
+ (void)saveProfile:(liveCommon *)user
{
    ...
    [userDefaults setObject:user.pravitelive_switch forKey:pravitelive_switch];
    ...
    pasteaname_votes.string = user.name_votes;
